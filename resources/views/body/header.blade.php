                ...
                <nav class="jas-navigation flex center-xs">
                    <ul id="jas-menu" class="jas-menu clearfix">
                        ...
                        <li id="menu-item-5754"
                            ...
                            <ul class="sub-menu">
                                <li id="menu-item-6205" class="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a href="product-category/bergo/index.html">BERGO</a></li>
                                <li id="menu-item-6206" class="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a href="product-category/khimar/index.html">KHIMAR</a></li>
                            </ul>
                        </li>
                        <li id="menu-item-5755" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                            <a href="product-category/ukhti/">UKHTI</a></li>
                    </ul>
                </nav><!-- .jas-navigation -->
            </div>
